  ...
  return (
    ...
    <main className="w-full overflow-x-hidden bg-[#FCF9F6] dark:bg-[#121212] transition-colors duration-500">
      ...
      <section className="relative w-screen h-screen left-[50%] right-[50%] -ml-[50vw] -mr-[50vw] bg-[#F3E5D8] dark:bg-[#1A1A1A] overflow-hidden flex items-center transition-colors duration-500">
        {/* Subtle caramel gradient - Adjusted for dark mode */}
        ...
        <div className="relative z-10 px-6 md:px-16 lg:px-24 w-full max-w-[1800px] mx-auto">
          <div className="animate-in fade-in slide-in-from-bottom-10 duration-1000 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            
            {/* Left Column: The Hook */}
            <div className="space-y-8">
              <div className="space-y-2">
                <span className="text-[#8B5E3C] dark:text-[#D9A066] text-[10px] uppercase tracking-[0.8em] font-bold block mb-4">
      ...
      <section className="py-32 px-4 md:px-8 max-w-[1400px] mx-auto bg-[#FCF9F6] dark:bg-[#121212] transition-colors">
        <div className="flex flex-col lg:flex-row justify-between items-center lg:items-end mb-16 gap-8 px-2">
          <div className="flex flex-col items-center lg:items-start space-y-3 text-center lg:text-left">
            <h2 className="text-[10px] md:text-sm uppercase tracking-[0.4em] text-[#A67B5B] dark:text-[#D9A066] font-bold">
              The Essentials
            </h2>
            <p className="text-5xl md:text-7xl font-serif leading-none tracking-tighter text-[#3E2723] dark:text-[#F3E5D8]">
              Signature Features
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-10">
          ...
          <CategoryCard title="Custumization" desc="Tailored vision" img="/alden.png" />
      ...
      <section className="relative w-screen left-[50%] right-[50%] -ml-[50vw] -mr-[50vw] bg-gradient-to-b from-[#FCF9F6] via-[#F3E5D8] to-[#EAD8C0] dark:from-[#121212] dark:via-[#1A1A1A] dark:to-[#000000] pt-10 pb-20 overflow-hidden transition-colors">        
        <div className="max-w-5xl mx-auto text-center px-6 space-y-12">
          <div className="space-y-4">
            <span className="text-[10px] uppercase tracking-[1em] text-[#8B5E3C] dark:text-[#D9A066] font-bold block opacity-70">
              Our Philosophy
            </span>
          ...
          <div className="space-y-10">
            ...
            <p className="text-[#5D4037] dark:text-[#A67B5B] max-w-xl mx-auto leading-relaxed text-lg transition-colors">
...
function CategoryCard({ title, desc, img }: { title: string, desc: string, img: string }) {
  return (
    <div className="group relative aspect-[3/4] overflow-hidden bg-[#EAD8C0] dark:bg-[#1A1A1A] transition-all duration-700">
      <Image 
        src={img} 
        alt={title} 
        fill 
        className="object-cover transition-transform duration-[2s] ease-out group-hover:scale-110 sepia-[.2] dark:sepia-[.4] group-hover:sepia-0" 
      />
      <div className="absolute inset-0 bg-gradient-to-t from-[#3E2723]/90 dark:from-black via-transparent to-transparent opacity-60 group-hover:opacity-80 transition-opacity" />
      <div className="absolute bottom-10 left-8 z-20 text-[#FCF9F6] space-y-2">
        <h3 className="text-4xl font-serif tracking-tighter">{title}</h3>
        <p className="text-[10px] font-bold uppercase tracking-widest text-[#D9A066]">
          {desc}
        </p>
      </div>
